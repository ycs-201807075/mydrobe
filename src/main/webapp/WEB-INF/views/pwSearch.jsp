  ...
  <body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
	...
	<div class="card align-middle" style="width:25rem;">
		<div class="card-title" style="margin-top:30px;">
			...
			<h2 class="card-title" style="color:#f58b34;"><img src="images/mydrobe_logo.png"/></h2>
		</div>
      ...
      <form action="findPw" class="form-signin" method="POST">
        ...
        <div class="links">
            <a href="?target=idSearch">아이디 찾기</a> | <a href="?target=login">로그인</a> | <a href="?target=join">회원가입</a>
